...
#define SET_GET_FUNC(__type__,__name__,__func__) protected:__type__ m##__name__;\
											public:__type__ get##__func__(){return m##__name__;}\
											public:void set##__func__(const __type__ &var){m##__name__ = var;}

#define SET_FUNC(__type__,__name__,__func__) protected:__type__ m##__name__;\
										public:void set##__func__(const __type__ &var){m##__name__ = var;}

#define GET_FUNC(__type__,__name__,__func__) protected:__type__ m##__name__;\
										public:__type__ get##__func__(){return m##__name__;}
...
#define SET_GET_FUNC_N(__type__,__name__,__num__,__func__) \
	protected:__type__ m##__name__[__num__];\
	public:__type__ *get##__func__(){return m##__name__;}\
	public:void set##__func__(const __type__ *var){strcpy(m##__name__,var);}

#define SET_FUNC_N(__type__,__name__,__num__,__func__) protected:__type__ m##__name__[__num__];\
										public:void set##__func__(const __type__ &var){strcpy(m##__name__,var);}

#define GET_FUNC_N(__type__,__name__,__num__,__func__) protected:__type__ m##__name__[__num__];\
										public:__type__ *get##__func__(){return m##__name__;}
...
#define V_SET_GET_FUNC(__type__,__name__,__func__) protected:__type__ m##__name__;\
											public:__type__ get##__func__();\
											public:void set##__func__(const __type__ &var);

#define V_SET_FUNC(__type__,__name__,__func__) protected:__type__ m##__name__;\
										public:void set##__func__(const __type__ &var);

#define V_GET_FUNC(__type__,__name__,__func__) protected:__type__ m##__name__;\
										public:__type__ get##__func__();
